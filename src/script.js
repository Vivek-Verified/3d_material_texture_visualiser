...
const geometry = new THREE.SphereGeometry(1, 100, 32);
...
// initialize the mesh
const sphere1 = new THREE.Mesh(geometry, grassMaterial);
const sphere2 = new THREE.Mesh(geometry, boulderMaterial);
const sphere3 = new THREE.Mesh(geometry, spaceCruiserMaterial);
